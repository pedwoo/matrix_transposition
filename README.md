...
2. [State of the art](#2-state-of-the-art)  
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.3. [Parallelization with hybrid approaches](#214-hybrid-approaches)  
...
5. [Results](#5-results)  
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.2.1. [Transposition performance on Unitn cluster](#521-transpositon-performance-on-unitn-cluster)  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.2.2. [Symmetry check performance on Unitn cluster](#522-symmetry-check-performance-on-unitn-cluster)  
